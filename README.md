...
docker build --secret id=GH_OWNER --secret id=GH_PAT -t "$loginserver/play.inventory:$version" .
...
#re-tag the image
docker tag play.inventory:$version "$loginserver/play.inventory:$version"
